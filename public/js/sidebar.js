const Sidebutton = {
    props: ["text", "route"],
    template: `
        <li class="nav-item rounded border border-primary mb-2" style="background-color: #9AC8D9;">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-white p-0 m-0">
        ...
        <div class="dropdown">
            <ul class="mb-auto rounded nav nav-pills flex-column p-2">
                ...
                <li class="nav-item rounded border border-primary mb-2" style="background-color: #8BB8C8;">
